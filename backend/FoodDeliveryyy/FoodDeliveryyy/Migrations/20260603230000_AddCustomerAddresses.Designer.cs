...
namespace FoodDeliveryyy.Migrations
{
    ...
    [Migration("20260603230000_AddCustomerAddresses")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FoodDeliveryyy.Models.Entities.BranchApplication", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("CreateBranchManager")
                        .HasColumnType("tinyint(1)");
                    ...
                    b.ToTable("BranchApplications");
                });

            modelBuilder.Entity("FoodDeliveryyy.Models.Entities.BranchModificationRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FoodDeliveryyy.Models.Entities.CustomerAddress", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FoodDeliveryyy.Models.Entities.MenuItemBranch", b =>
                {
                    ...
                    b.Property<string>("RequestOptions")
                        .HasColumnType("longtext");
            ...
            modelBuilder.Entity("FoodDeliveryyy.Models.Entities.Orders", b =>
                {
                    ...
                    b.Property<DateTime?>("StatusiUpdatedAt")
                        .HasColumnType("datetime(6)");
            ...
            modelBuilder.Entity("FoodDeliveryyy.Models.Entities.BranchModificationRequest", b =>
                {
                    b.HasOne("FoodDeliveryyy.Models.Entities.RestaurantAddress", "Branch")
                        .WithMany()
                        .HasForeignKey("BranchId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FoodDeliveryyy.Models.Identity.User", "Requester")
                        .WithMany()
            ...
            modelBuilder.Entity("FoodDeliveryyy.Models.Entities.Restaurant", b =>
                {
                    b.HasOne("FoodDeliveryyy.Models.Entities.Category", "Category")
            ...
            modelBuilder.Entity("FoodDeliveryyy.Models.Entities.RestaurantAddress", b =>
                {
                    b.HasOne("FoodDeliveryyy.Models.Identity.User", "MerchantUser")
                        .WithMany()
            ...
            modelBuilder.Entity("FoodDeliveryyy.Models.Entities.UserFavorite", b =>
                {
                    b.HasOne("FoodDeliveryyy.Models.Entities.MenuItems", "MenuItems")
                        .WithMany()
                        .HasForeignKey("MenuItemId");
